...
// Civilization specific tech trees by ClassicThunder - merk.tc
...
void CvCivilizationInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iTechChannel); //Civilization specific tech trees by ClassicThunder - merk.tc
...
void CvCivilizationInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iTechChannel); //Civilization specific tech trees by ClassicThunder - merk.tc
...
bool CvCivilizationInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_iTechChannel, "iTechChannel", -1); //Civilization specific tech trees by ClassicThunder - merk.tc
