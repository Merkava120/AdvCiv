...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_GW_RELATIVE_CONTRIBUTION", WIDGET_HELP_GW_RELATIVE_CONTRIBUTION)
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_SPAH", GAMEOPTION_SPAH) // advc.250b
		.value("GAMEOPTION_NO_CITY_FLIPPING", GAMEOPTION_NO_CITY_FLIPPING)
		// advc.101:
		.value("GAMEOPTION_NO_FLIPPING_AFTER_CONQUEST", GAMEOPTION_NO_FLIPPING_AFTER_CONQUEST)
		...
		.value("GAMEOPTION_RISE_FALL", GAMEOPTION_RISE_FALL) // advc.701
		.value("GAMEOPTION_TRUE_STARTS", GAMEOPTION_TRUE_STARTS) // advc.tsl
		.value("GAMEOPTION_NO_GOODY_HUTS", GAMEOPTION_NO_GOODY_HUTS)
		.value("GAMEOPTION_NO_EVENTS", GAMEOPTION_NO_EVENTS)
		.value("GAMEOPTION_NO_VASSAL_STATES", GAMEOPTION_NO_VASSAL_STATES) // advc.tsl (moved down)
	...
	python::enum_<UnitAITypes>("UnitAITypes")
		...
		.value("UNITAI_GREAT_SPY", UNITAI_GREAT_SPY) // K-Mod
	...
	python::enum_<MissionAITypes>("MissionAITypes")
		...
		.value("MISSIONAI_GUARD_COAST", MISSIONAI_GUARD_COAST)
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_FACTION_SCREEN", CONTROL_FACTION_SCREEN) // merk.facinterface
	...
	python::enum_<DiploEventTypes>("DiploEventTypes")
		...
		.value("DIPLOEVENT_SET_WARPLAN", DIPLOEVENT_SET_WARPLAN) // K-Mod
	...
	python::enum_<MemoryTypes>("MemoryTypes")
		...
		// advc.143:
		.value("MEMORY_CANCELLED_VASSAL_AGREEMENT", MEMORY_CANCELLED_VASSAL_AGREEMENT)
		...
		// advc.130p:
		.value("MEMORY_CANCELLED_DEFENSIVE_PACT", MEMORY_CANCELLED_DEFENSIVE_PACT)
