...
public: // advc: made several functions const
	...
	// merkava.mb1tL
	int getActualTopLatitude() const
	{
		return m_iActualTopLatitude;
	}
	int getActualBottomLatitude() const
	{
		return m_iActualBottomLatitude;
	}
	int getActualTileLatitude(int iTileLatitude) const
	{
		return (100 * (iTileLatitude - getBottomLatitude()) / (getTopLatitude() - getBottomLatitude())) * (getActualTopLatitude() - getActualBottomLatitude() / 100) + getActualBottomLatitude();
	}
	void calculateActualLatitudes(); // combined setter for both based on terrain temperatures
	// mb1d
	void addBiomeSigns();
	// merkava END
...
protected:
	...
	int m_iTopLatitude;
	int m_iBottomLatitude;
	int m_iActualTopLatitude;
	int m_iActualBottomLatitude;
